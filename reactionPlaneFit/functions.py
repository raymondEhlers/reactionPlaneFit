...
def background_wrapper(phi: float, c: float, resolutionParameters: dict, background_function: Callable[..., float]):
    ...
    def bg_wrapper(x: float, B: float, v2_t: float, v2_a: float, v4_t: float, v4_a: float, v1: float, v3: float, **kwargs: dict) -> float:
        ...
        return background_function(x, phi = phi, c = c, resolutionParameters = resolutionParameters,
                                   B = B,
                                   v2_t = v2_t, v2_a = v2_a,
                                   v4_t = v4_t, v4_a = v4_a,
                                   v1 = v1,
